...
export default class Pisca extends Component {
  render() {
    let pic = {
      uri:
        "https://media1.tenor.com/images/fef20bda62d288814a89e5cecb16707a/tenor.gif?itemid=14252824"
    };
    return (
      <ImageBackground
        source={bgImage}
      ...
      >
        <View>
          <Text>
            {"Disseram que a distancia com o universo é intransponível"}{" "}
          </Text>
          ...
          <Text>
            {"e NADA NADA NADA no mundo pode brilhar mais do que você"}
          </Text>
          <Text>
            {
              "Você é tão incrível que consegue fazer meus dias valerem a pena com um sorriso"
            }
          </Text>
          ...
          <Text>
            {"Percebi que quando eu te chamo de 8 maravilha do mundo"}
          </Text>
          <Text>{"Eu to sendo muito leigo "}</Text>
          <Text>
            {"Já que as outras maravilhas parecem nada se comparadas a você"}
          </Text>
